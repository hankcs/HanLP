...
from hanlp.components.classifiers.bert_text_classifier import TransformerClassifier, BertTextTransform
...
classifier = TransformerClassifier(BertTextTransform(y_column=0))
