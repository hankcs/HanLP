...
public class DemoTextClassification
{
     ...
     */
    public static final String CORPUS_FOLDER = TestUtility.ensureData("搜狗文本分类语料库迷你版", "http://hanlp.linrunsoft.com/release/corpus/sogou-text-classification-corpus-mini.zip");
    /**
     * 模型保存路径
     */
