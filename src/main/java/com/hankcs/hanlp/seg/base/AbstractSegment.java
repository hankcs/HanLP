...
import com.hankcs.hanlp.seg.common.Config;
...
//        }
     ...
     * @return
     */
    public AbstractSegment enableIndexMode(boolean enable)
    {
     ...
     * @return
     */
    public AbstractSegment enableIndexMode(int minimalLength)
    {
     ...
     * @return
     */
    public AbstractSegment enableNameRecognize(boolean enable)
    {
     ...
     * @return
     */
    public AbstractSegment enablePlaceRecognize(boolean enable)
    {
     ...
     * @return
     */
    public AbstractSegment enableOrganizationRecognize(boolean enable)
    {
     ...
     * @since 1.3.5
     */
    public AbstractSegment enableCustomDictionaryForcing(boolean enable)
    {
        if (enable)
        {
     ...
     * @param enable
     */
    public AbstractSegment enableTranslatedNameRecognize(boolean enable)
    {
     ...
     * @param enable
     */
    public AbstractSegment enableJapaneseNameRecognize(boolean enable)
    {
     ...
     * @return
     */
    public AbstractSegment enableOffset(boolean enable)
    {
     ...
     * @return
     */
    public AbstractSegment enableAllNamedEntityRecognize(boolean enable)
    {
        config.nameRecognize = enable;
        config.japaneseNameRecognize = enable;
        config.translatedNameRecognize = enable;
     ...
     * @return
     */
    public AbstractSegment enableMultithreading(boolean enable)
    {
     ...
     * @return
     */
    public AbstractSegment enableMultithreading(int threadNumber)
    {
