...
public abstract class CommonDictionaryMaker implements ISaveAble
{
     ...
     * 处理语料，准备词典
     */
    public void compute(List<List<Word>> sentenceList)
    {
     ...
     * @param sentenceList
     */
    abstract protected void addToDictionary(List<List<Word>> sentenceList);

    /**
     * 角色标注，如果子类要进行label的调整或增加新的首尾等等，可以在此进行
     */
    abstract protected void roleTag(List<List<Word>> sentenceList);
}
